/**
 * FitDuo & Collie Coach - Main Application Orchestrator (v0.25.2)
...
import {
  ...
  getActiveWeeklyPlan,
  setNutritionActiveWeek,
  nextNutritionWeek,
  prevNutritionWeek,
  goToCurrentNutritionWeek,
  ...
  setAiPrompt,
  saveGeneratedRecipeCandidate,
  editGeneratedRecipeCandidate,
  saveAllBatchCookingRecipes,
  saveSingleBatchRecipe,
  removeSingleBatchRecipe,
  editSingleBatchRecipe,
  toggleBatchRecipeAiAlternative,
  setBatchAltPrompt,
  applyBatchRecipeAiAlternative,
  setAddBatchRecipePrompt,
  applyAddBatchRecipe,
  autoCalculateRecipeModalMacros,
  setShoppingRange,
  toggleShoppingDay,
  toggleAllShoppingDays,
  setShoppingDaysPreset,
  renderShoppingView,
  toggleShoppingItem,
  ...
  removeShoppingExtra,
  copyShoppingList,
  copyMercadonaShoppingList,
  openBatchCookingView,
  renderBatchCookingView,
  copyBatchCookingPlanToClipboard,
  getMealSlotServings,
  setMealSlotServings,
  toggleSlotServings
...
import {
  ...
  switchExerciseMediaStage,
  getEquipmentIcon,
  renderEquipmentIcons,
  setWorkoutsHistoryPeriod,
  renderWorkoutsHistoryView
} from './js/views/workoutsView.js';

import {
  setBooSubTab,
  toggleBooProgramStep,
  toggleBooSosCard,
  toggleBooWhyCard,
  saveBooDistractionLog,
  deleteBooDistractionLog,
...
export function initApp() {
  try {
    ...
    console.log("🚀 FitDuo & Collie Coach initialized successfully (v0.25.2)");
  } catch(e) {
