import { appState, LOCAL_STORAGE_KEY, LAST_ACTIVE_PROFILE_KEY, DEVICE_DEFAULT_PROFILE_KEY, getMasterProfileId, getTodayDayName, triggerHapticTouch, showIosToast, saveState, renderDebugLogsView } from './state.js';
